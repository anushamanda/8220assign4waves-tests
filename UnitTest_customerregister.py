...
class waves_Test1(unittest.TestCase):
    ...
    def test_customerregister(self):
        ...
        elem = driver.find_element_by_xpath('//*[@id="myNavbar"]/ul/li[1]/a/b').click()
        #time.sleep(0.5)
        #elem = driver.find_element_by_xpath('//*[@id="app-layout"]/div/div/div/div/div/div/div/div[3]/a[2]').click()
        elem = driver.find_element_by_id("id_username")
        elem.send_keys("customer3")
        elem = driver.find_element_by_id("id_email")
        elem.send_keys("anushamanda3@gmail.com")
        ...
        try:
            ...
            elem = driver.find_element_by_xpath('//*[@id="app-layout"]/div/div/div/div/div/div/div/div[2]/div/form/p/input')
            assert True
